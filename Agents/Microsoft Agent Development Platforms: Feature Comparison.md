...
| Orchestrator support | Default from M365 Copilot | Default from Copilot Studio | Default from M365 Copilot | Default + Custom |
| Underlying base LLM model(s) support | Default (Open AI) | Default (Open AI), Claude, BYOM from Foundry (Soon) | Default (Open AI) | Default + BYOM |
